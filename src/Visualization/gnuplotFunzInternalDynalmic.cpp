...
////[]*******************************************************
//
//void CV_rExp_tExp::gnuplotFunzInternalDynalmic(string title, int save_, int gen_con_sim){
//    
//    title.erase(title.end()-4, title.end());
//    
//    //
//    //    cout << "*********************************************\n";
//    //    cout << "tipo_lambda = " << tipo_lambda << endl;
//    //    cout << "A0 = " << A_0 << endl;
//    //    cout << "A1 = " << A_1 << endl;
//    //    cout << "A2 = " << A_2 << endl;
//    //    cout << "tau_r = " << tau_r << endl;
//    //    cout << "tau_t = " << tau_t << endl;
//    //    cout << "*********************************************\n";
//    
//    {
//        
...
//        dynFile+="dynamic.dat";
//        
//        string file_single_plotName(buffer);
//        file_single_plotName+="plot_batterium.gnu";
//        
//        file_single_plot.open(file_single_plotName.c_str());
//        
//        file_gnu.open(file_gnuName.c_str());
//        
//        
//        
//        if (!is_file_exist(dynFile.c_str())) {
...
//        }
//        
//        writeScriptInternalDyn(save_conform, title, dynFile, EXP, gen_con_sim);
//        
//        
//        if (save_==0) {
...
//            file_gnu << "set size ratio 0.71" << endl;
//            string buffer = "_FunzRisp.eps";
//            //            title=buffer1+title+buffer;
//            string title_out=title+buffer;
//            file_gnu << "set output \""<< title_out <<"\"" << endl;
//            
//        }
//        
//        file_gnu << "b=1;" << endl
//        << "load \""<< setNameScriptIntDyn(gen_con_sim, save_conform) << "\""<< endl;
//        
//        //        if (save_!=0) {
...
//        
//        
//        lunch_gnuplot(file_gnuName);
//        
//        if (save_==0) {
//            CV_rExp_tExp::gnuplotFunzInternalDynalmic(title,1,gen_con_sim);
//        }
//        
//        
//    }
...
////[]*******************************************************
//
//void ParameterEstimation_CV_rExp_tExp::gnuplotFunzInternalDynalmic(string title, int save_, int gen_con_sim){
//    
//    title.erase(title.end()-4, title.end());
//    
//    {
...
//            for (int i=0; i<n_r; i++) {
//                
//                //                cout << s_lambda_r.syntetic_indeX[i] << " " << 1/s_lambda_r.lambda[i] << endl;
//                file_dat << s_lambda_r.syntetic_indeX[i] << " " << s_lambda_r.lambda[i] << endl;
//                
//            }
//            
...
//        //        char buffer1[16];
//        //        if (simulation==0) {
//        //            snprintf(buffer1, sizeof(char) * 16,"sim-%03d-",gen_con_sim);
//        //        }else {
//        //            snprintf(buffer1, sizeof(char) * 16,"simStat-%03d-",gen_con_sim);
//        //        }
//        
//        
//        file_single_plot << "set title \"Response Functions "<< title << "\" font \",14\""<< endl;
//        
//        {
//            
//            file_single_plot << "set grid ytics lc rgb \"#bbbbbb\" lw 1 lt 0" << endl;
//            file_single_plot << "set grid xtics lc rgb \"#bbbbbb\" lw 1 lt 0" << endl
//            << "set xlabel 'Q' "<< endl
//            << "set ylabel 'lambda(Q)' "<< endl;
//            
//            file_single_plot << "plot \"dynamic.dat\" u 1:2 w l title 'lambda(Q)'" << endl;
//            
//        }
//        
//        //        file_single_plot << "unset multiplot" << endl;
...
////[]*******************************************************
//
//void CV_rIG_tExp::gnuplotFunzInternalDynalmic(string title, int save_, int gen_con_sim){
//    
//    title.erase(title.end()-4, title.end());
//    
//    char buffer[8];
...
//        
//        
//        file_single_plot << "set multiplot layout 2,1 title \"Response Functions "<< title << "\" font \",14\""<< endl;
//        
//        {
//            
//            file_single_plot << "set grid ytics lc rgb \"#bbbbbb\" lw 1 lt 0" << endl;
...
//            file_single_plot << "set grid xtics lc rgb \"#bbbbbb\" lw 1 lt 0" << endl
//            << "set xlabel 'Q' "<< endl
//            << "set ylabel 'sigma(Q)' "<< endl;
//            
//            file_single_plot << "plot \"dynamic.dat\" u 1:3 w l title 'sigma(Q)'" << endl;
//        }
//        
//        file_single_plot << "unset multiplot" << endl;
//        
...
////[]*******************************************************
//
//void ParameterEstimation_CV_rIG_tExp::gnuplotFunzInternalDynalmic(string title, int save_, int gen_con_sim){
//    
//    title.erase(title.end()-4, title.end());
//    
//    {
...
////[]*******************************************************
//
//void EO_rExp_tExp::gnuplotFunzInternalDynalmic(string title, int save_, int gen_con_sim){
//    
//    title.erase(title.end()-4, title.end());
//    
//    {
...
//            << "set ylabel 'lambda(Q)' "<< endl;
//            
//            file_single_plot << "plot \"dynamic.dat\" u 1:2 w l title 'lambda(Q)',"
...
//        
//        if (save_==0) {
//            EO_rExp_tExp::gnuplotFunzInternalDynalmic(title,1,gen_con_sim);
//        }
//        
//        
//    }
...
////[]*******************************************************
//
//void EO_rIG_tExp::gnuplotFunzInternalDynalmic(string title, int save_, int gen_con_sim){
//    
//    title.erase(title.end()-4, title.end());
//    
//    {
