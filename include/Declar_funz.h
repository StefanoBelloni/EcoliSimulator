...
void inizializzazione_parametri(int sel_prog, double &T_f, int &n_c, double* x0, int &num_dist,double &Raggio, int &delta_dist, int &const_salv, double &dt, std::string name_file,std::vector<Funz_C*> &f, int &tipo_funz_c_class, int &tipo_response_c, double &RC_0, double &RC_1, int &RC_q);
//************
...
int simulation_independent_setting(E_coli *batterio,double T_f,Funz_C *f,double *x0,double dt,int n_c,double Raggio,int delta_dist, int num_dist,int const_salv,std::string *names_Ecoli_mod, std::string names_indice_mod, std::string *names_tau_mod, std::string names_file_dyn_mod, std::string *names_info_mod, int n_sim, int &cont_gen_sim);
...
int simulation_interacting(std::vector<E_coli*> batterio, double T_f,Funz_C *f,double *x0,double dt,int n_c,double Raggio,int delta_dist, int num_dist,int const_salv, std::string *names_files_Ecoli_mod, std::string names_indice_mod, std::string *names_files_tau_mod, std::string names_file_dyn_mod, std::string *names_info_mod, int cont_gen_sim, double &f_max);
...
void gnuplot_large_population(std::string file_info[], std::string name_dyn ,double T_f, int n_c, int dim_col_t, std::string names, Funz_C *f, int cont_gen_sim);
...
//*****************
int independent_population(Funz_C* f, int n_compare, std::string *names_Ecoli_mod, std::string &names_indice_mod, std::string *names_tau_mod, std::string &names_file_dyn_mod, std::string *names_info_mod, int sel_prog, std::vector<int> &which_compare, std::vector<E_coli* > &batteri, double T_f, double *x0, double dt,int n_c, double Raggio,int delta_dist, int num_dist,int const_salv, std::string &versione_Matlab, std::string names_jumps[], int &cont_gen_sim, int stat_ = 1, std::vector<std::string> *pt_name_file_satistics = 0, std::vector<std::string> *pt_name_info_satistics = 0);

//*****************


int interaction_population(Funz_C* f, int n_compare, std::string *names_Ecoli_mod, std::string &names_indice_mod, std::string *names_tau_mod, std::string &names_file_dyn_mod, std::string *names_info_mod, int tipo_simulazione, int sel_prog, std::vector<E_coli* > &batteri_int, double T_f, double *x0,double dt,int n_c,double Raggio,int delta_dist, int num_dist,int const_salv, std::string &versione_Matlab, std::string names_jumps[], int &cont_gen_sim, int &which_compare);


void initialization_interacting_population(int tipo_simulazione, std::vector<E_coli* > *batteri_int, int n_c, int cont_gen_sim);

//*****************
void FunzRunUndTumble(double T_f, int n_c, int cont_gen_sim, int n_compare, std::string *names_Ecoli_mod, std::string names_indice_mod, std::string *names_tau_mod, std::string names_file_dyn_mod, std::string *names_info_mod, std::string *names_jumps, int sel_prog, std::vector<E_coli*> batteri, std::vector<int> &which_compare, int stat_);
void FunzRunUndTumble(double T_f, int n_c, int cont_gen_sim, int n_compare, std::string *names_Ecoli_mod, std::string names_indice_mod, std::string *names_tau_mod, std::string names_file_dyn_mod, std::string *names_info_mod, std::string *names_jumps, int sel_prog, std::vector<E_coli*> batteri, int which_compare, int stat_);
//*****************
...
void File_statistics(E_coli *batterio,double T_f,Funz_C *f,double *x0,double dt,int n_c,double Raggio,int delta_dist, int num_dist,int const_salv,std::string *names_Ecoli_mod, std::string names_indice_mod, std::string *names_tau_mod, std::string names_file_dyn_mod, std::string *names_info_mod, int i, int &cont_gen_sim,std::vector<std::string> *pt_name_file_satistics, std::vector<std::string> *pt_name_info_satistics);
